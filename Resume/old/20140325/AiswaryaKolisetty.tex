...
\smallskip
\moveleft.5\hoffset\centerline{\large blog/work: www.aiswaryakolisetty.com}
\smallskip
...
\section{EMPLOYMENT}  \hspace*{7mm}{\large\bf Ford Motor Company} in Dearborn, MI \hfill July 2013 - Present\\
  \hspace*{7mm}{User Experience Research Engineer } \\ 
\smallskip
  \hspace*{7mm}\normalsize On contract from Kelly Services starting July 2014 \	
...
\smallskip
	...
	\item  Implementing front-end prototypes using HTML/CSS, Javascript, APIs, and cloud data
	\item  Deploying prototypes in-vehicle using embedded frameworks (C\#, C++)
...
\smallskip
	\begin{itemize}  \itemsep -4pt %reduce space between items
	 ...
	 \item Conducted usability testing to help a startup enhance their product UI
